...
/* package gitpractice-0.1.0.0 */
#ifndef VERSION_gitpractice
#define VERSION_gitpractice "0.1.0.0"
#endif /* VERSION_gitpractice */
#ifndef MIN_VERSION_gitpractice
#define MIN_VERSION_gitpractice(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_gitpractice */
...
#define CURRENT_COMPONENT_ID "gitpractice-0.1.0.0-inplace-gitpractice"
